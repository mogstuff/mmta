...
if (navigator.geolocation) {
    ...
    // This is the location marker that we will be using on the map. 
    //Let's store a reference to it here so that it can be updated in several places.
    ...
    navigator.geolocation.getCurrentPosition(
        function (position) {
            ...
            // Check to see if there is already a location. There is a bug in FireFox where this 
            //gets invoked more than once with a cached result.
            if (locationMarker){
                return;
            }
